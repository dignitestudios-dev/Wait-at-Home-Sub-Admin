...
import { chats, requestchats } from "../../../../static/Sidebar";
        ...
        >
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center">
              ...
              {chat.active && (
                <div className="bg-[#173C73] w-[18px] h-[18px] font-[500] rounded-full text-white text-[12px] flex items-center justify-center ml-2">
                  1
                </div>
              )}
            </div>
