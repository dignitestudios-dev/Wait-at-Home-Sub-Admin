...
const ChatCompletedModal = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 bg-opacity-60">
      ...
      >
        <div className="flex flex-col items-center justify-center text-center space-y-3">
          <div className="bg-[#00AAAD] flex justify-center items-center w-[107px] h-[107px] rounded-full">
            <img src={Tick} className="h-[62px] w-[62px]" alt="Success Tick" />
          </div>
          <h2 className="text-[24px] font-[600]">Chat Completed</h2>
          <p className="text-[16px] font-[400] text-[#565656] max-w-[350px]">
            Chat has been Completed Successfully
          </p>
        </div>
      </div>
    </div>
...
export default ChatCompletedModal;
